...
/// بعد اختيار مركبة: قائمة الأيام التي فيها مبيعات؛ الضغط يفتح تفاصيل اليوم.
class VehicleSalesVehicleDaysListPage extends StatefulWidget {
  const VehicleSalesVehicleDaysListPage({
    super.key,
  ...
  @override
  State<VehicleSalesVehicleDaysListPage> createState() =>
      _VehicleSalesVehicleDaysListPageState();
}

class _VehicleSalesVehicleDaysListPageState
    extends State<VehicleSalesVehicleDaysListPage> {
  bool _loading = true;
  String? _error;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          l10n.vehicleSalesDaysListTitle(_vehicleLabel()),
          maxLines: 2,
      ...
      itemBuilder: (BuildContext context, int i) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            onTap: () {
              context.push(
                '${widget.shellBase}/vehicle-sales/${widget.vehicleId}/day/$dayKey',
