...
class _SuperAdminUsersBody extends StatelessWidget {
  const _SuperAdminUsersBody();

  String _roleLabel(BuildContext context, String? role) {
    final l10n = context.l10n;
    return switch (role) {
      'super_admin' => l10n.userRoleSuperAdmin,
      'admin' => l10n.userRoleAdminOption,
      'driver' => l10n.userRoleDriverOption,
      _ => role ?? '—',
    };
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => showAddSuperAdminUserSheet(context),
